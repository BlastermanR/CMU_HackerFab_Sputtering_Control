...
// Structure representing a pressure value in both fractional/exponential form
// and absolute value
...
// Converts a raw pressure string from the Pfeiffer gauge to a
// pressure_measurement struct
...
// Optional global variables to expose pressure values externally (currently
// unused in some files)
