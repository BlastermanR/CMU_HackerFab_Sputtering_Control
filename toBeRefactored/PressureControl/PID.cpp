...
// Initializes PID coefficients based on the order of magnitude of the target
// pressure
                           ...
                           float currSetPoint, const unsigned long sample_interval)
{
    ...
    if (abs(proportional) < 0.01)
    {
        ...
        if (integralFillCount < INTEGRAL_WINDOW)
            integralFillCount++;
