...
{
    return static_cast<SafetyFault>(static_cast<uint16_t>(a) | static_cast<uint16_t>(b));
}
...
class SputteringProcess
{
  public:
    ...
    SputteringProcess(AlicatMFC &mfc_argon, AlicatMFC &mfc_oxygen, PfeifferGauge &gauge, PfeifferPump &pump);
